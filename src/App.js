    ...
    <div className="app">
      ...
      <NavBar setPage={setPage} goToWork={goToWork}></NavBar>
        <div className='links'> 
          ...
          <Link linkaddr='https://www.linkedin.com/in/jason-chen9/' img={`${process.env.PUBLIC_URL}/icons8-linkedin-50.png`} name='LinkedIn'dark={darkMode}></Link>
          <Link linkaddr='https://github.com/Jasonchen272' img={`${process.env.PUBLIC_URL}/github-mark.png`} name='Github' dark={darkMode}></Link>
        </div>
      </div>
      <div className='tabs'>
